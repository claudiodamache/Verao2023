...
if __name__ == "__main__":
    ...
    parser.add_argument("-f", "--files", type=str, default= "/lstore/cms/cbeiraod/Verao2023/2016/")
    parser.add_argument("-v", "--variables", type=list) #json file with variables
    parser.add_argument("-unblind", "--data", type=bool, default=False )
    args = parser.parse_args()
    
    graf = Plots(args.json_plot, args.json_var, args.files, args.variables, args.data)
